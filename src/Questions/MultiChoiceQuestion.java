...
public class MultiChoiceQuestion {
    ...
    /**
     * Returns if the chaser's and/or player's answer is correct or not for each
     * question. Returns a different number depending for both correct, just
     * player correct, just chaser correct, neither correct, and incorrect
     * input.
     *
