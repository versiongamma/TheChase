...
public class Board {
    ...
    /**
     * Constructor for Game.Board object. Assigns default values to playerPosition, chaserPosition,
     * and moneyChoice.
     * 
    ...
    /**
     * Specifies which offer the player has chosen and assigns it to the variable moneyChoice
     * 
    ...
    /**
     * Assigns the variable playerPosition to which block on the board they will be sitting
     * at the start of the game based on the offer they chose.
     * 
    ...
    /**
     * Moves the player down one block on the board if they get a question correct.
     */
    ...
    /**
     * Moves the chaser down one block on the board if they get a question correct.
     */
    ...
    /**
     * Sets up and prints the initial board of the round, displaying the offers to the player.
     */
    ...
    /**
     * Calls the helper methods that will display the board as it changes throughout the game.
     */
    ...
    /**
     * Generates values to use for printing any red blank blocks needed before the chaser
     * block.
     */
    ...
    /**
     * Generates values to use for printing any green blank blocks needed between the chaser
     * block and the player block.
     */
    ...
    /**
     * Generates values to use for printing any blue blank blocks needed after the player
     * block.
     */
    ...
    /**
     * Prints out any blank blocks on the board throughout the game with their specified
     * length, leading spaces, and background colour.
     * 
     * @param lineLength    the length of the text in each line of the block
     * @param leadingSpaces the number of spaces needed before each line of the block
     *                      to display the board in the correct shape
    ...
    /**
     * Prints out any blocks that have text in them (money blocks, chaser block, and
     * player block) in their specified sizes and colours.
     * 
